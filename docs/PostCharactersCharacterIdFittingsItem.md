...
------------ | ------------- | ------------- | -------------
**flag** | [**FlagEnum**](#FlagEnum) | Fitting location for the item. Entries placed in &#39;Invalid&#39; will be discarded. If this leaves the fitting with nothing, it will cause an error. | 
