...
package enterprises.orbital.eve.esi.client.invoker;
...
import enterprises.orbital.eve.esi.client.invoker.auth.ApiKeyAuth;
import enterprises.orbital.eve.esi.client.invoker.auth.Authentication;
import enterprises.orbital.eve.esi.client.invoker.auth.HttpBasicAuth;
import enterprises.orbital.eve.esi.client.invoker.auth.OAuth;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    /*
     * Use RFC3339 format for date and datetime. See http://xml2rfc.ietf.org/public/rfc/html/rfc3339.html#anchor14
     */
   ...
   *
   * @param basePath
   *          Base path of the URL (e.g https://esi.tech.ccp.is/latest
   * @return An instance of OkHttpClient
   */
  public ApiClient setBasePath(
                               String basePath) {
   ...
   * @return Api Client
   */
  public ApiClient setHttpClient(
  ...
  /**
   * Configure whether to verify certificate and hostname when making https requests. Default to true. NOTE: Do NOT set to false in production code, otherwise
   * you would face multiple types of cryptographic attacks.
   *
   * @param verifyingSsl
   *          True to verify TLS/SSL connection
   * @return ApiClient
   */
  public ApiClient setVerifyingSsl(
  ...
  public ApiClient setDateFormat(
  ...
  public ApiClient setDatetimeFormat(
  ...
  public ApiClient setLenientDatetimeFormat(
                                            boolean lenientDatetimeFormat) {
   ...
   * 2015-08-16T08:20:05Z 2015-8-16T8:20:05Z 2015-08-16T08:20:05+00:00 2015-08-16T08:20:05+0000 2015-08-16T08:20:05.376Z 2015-08-16T08:20:05.376+00:00
   * 2015-08-16T08:20:05.376+00 Note: The 3-digit milli-seconds is optional. Time zone is required and can be in one of these formats: Z (same with +0000)
   * +08:00 (same with +0800) -02 (same with -0200) -0200
   * 
  ...
  public Date parseDatetime(
    ...
    if (lenientDatetimeFormat) {
      /*
       * When lenientDatetimeFormat is enabled, normalize the date string into <code>LENIENT_DATETIME_FORMAT</code> to support various formats defined by ISO
       * 8601.
       */
      // normalize time zone
   ...
   * @return Date representation of the string
   */
  public Date parseDateOrDatetime(
                                  String str) {
    if (str == null)
      return null;
   ...
   * @return ApiClient
   */
  public ApiClient addDefaultHeader(
                                    String key,
                                    String value) {
   ...
   * @return ApiClient
   */
  public ApiClient setLenientOnJson(
                                    boolean lenient) {
   ...
   * @return ApiClient
   */
  public ApiClient setTempFolderPath(
   ...
   * @return Api client
   */
  public ApiClient setConnectTimeout(
   ...
   */
  public String selectHeaderAccept(
                                   String[] accepts) {
   ...
   */
  public String selectHeaderContentType(
                                        String[] contentTypes) {
  ...
  public <T> T deserialize(
                           ...
                           Type returnType)
    throws ApiException {
    if (response == null || returnType == null) { return null; }
    ...
    if (respBody == null || "".equals(respBody)) { return null; }
    ...
    if (isJsonMime(contentType)) {
      ...
      throw new ApiException(
          "Content type \"" + contentType + "\" is not supported for type: " + returnType, response.code(), response.headers().toMultimap(), respBody);
    }
  }
   ...
   * @param call
   *          Call
   * @return ApiResponse object containing response status, headers and data, which is a Java object deserialized from response body and would be null when
   *         returnType is null.
   * @throws ApiException
   *           If fail to execute the call
   */
   ...
   *          Return type
   * @throws ApiException
   *           If the response has a unsuccessful status code or fail to deserialize the response body
   * @return Type
   */
  ...
  private void applySslSettings() {
    try {
      ...
      if (!verifyingSsl) {
        ...
        if (certificates.isEmpty()) { throw new IllegalArgumentException("expected non-empty set of trusted certificates"); }
