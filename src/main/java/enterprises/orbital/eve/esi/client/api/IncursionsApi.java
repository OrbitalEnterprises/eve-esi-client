...
public class IncursionsApi {
  ...
  private com.squareup.okhttp.Call getIncursionsCall(
                                                     String datasource,
  ...
  /**
   * List incursions Return a list of current incursions --- Alternate route: &#x60;/v1/incursions/&#x60; Alternate route: &#x60;/legacy/incursions/&#x60;
   * Alternate route: &#x60;/dev/incursions/&#x60; --- This route is cached for up to 300 seconds
   * 
   * @param datasource
   ...
   */
  public List<GetIncursions200Ok> getIncursions(
                                                String datasource)
    throws ApiException {
    ApiResponse<List<GetIncursions200Ok>> resp = getIncursionsWithHttpInfo(datasource);
    return resp.getData();
  }
   ...
   *           If fail to call the API, e.g. server error or cannot deserialize the response body
   */
  public ApiResponse<List<GetIncursions200Ok>> getIncursionsWithHttpInfo(
                                                                         String datasource)
    throws ApiException {
    com.squareup.okhttp.Call call = getIncursionsCall(datasource, null, null);
    Type localVarReturnType = new TypeToken<List<GetIncursions200Ok>>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * List incursions (asynchronously) Return a list of current incursions --- Alternate route: &#x60;/v1/incursions/&#x60; Alternate route:
   * &#x60;/legacy/incursions/&#x60; Alternate route: &#x60;/dev/incursions/&#x60; --- This route is cached for up to 300 seconds
   * 
   * @param datasource
   *          The server name you would like data from (optional, default to tranquility)
   * @param callback
   ...
   */
  public com.squareup.okhttp.Call getIncursionsAsync(
                                                     String datasource,
                                                     final ApiCallback<List<GetIncursions200Ok>> callback)
    throws ApiException {
    ...
    com.squareup.okhttp.Call call = getIncursionsCall(datasource, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<List<GetIncursions200Ok>>() {}.getType();
